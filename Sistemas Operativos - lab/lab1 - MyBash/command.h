...
/* Obtiene la longitud de la cola sc_arguments dentro de la estructura scommand. 
 *   Malloc para un array de punteros a cadenas de caracteres 
 *   (char **) con un tamaño igual a scmd_length + 1
 * 
 */
