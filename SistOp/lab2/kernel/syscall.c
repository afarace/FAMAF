...
extern uint64 sys_sem_amount_available(void);
extern uint64 sys_first_sem_available(void);
...
[SYS_sem_amount_available]  sys_sem_amount_available,
[SYS_first_sem_available]  sys_first_sem_available,
};
